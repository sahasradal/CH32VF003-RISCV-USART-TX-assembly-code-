...
R32_PFIC_IPRIORx = 0xE000E400 	#PFIC interrupt priority configuration register
...
R32_STK_CNTL = 0xE000F008	# System counter low register 
R32_STK_CMPLR = 0xE000F010 	#Counting comparison low register
